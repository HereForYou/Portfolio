...
<img width="630" height="200px" alt="Smart Fox Portfolio Website Lighthouse Score" src="public/lighthouse.svg">
<a>
...
```bash
git clone https://github.com/HereForYou/CleanPortfolio.git
```
