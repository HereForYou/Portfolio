    ...
    >
      ...
      <div className="overflow-hidden">
        <div className="text-animation text-2xl md:text-4xl font-semibold">
          ...
          <span className="text-accentColor">Solana Development</span>{" "}
      ...
      As a Senior Solana Trading, Arbitrage, and Snipe Bot Developer with over 
      5 years of rich experience in the blockchain and cryptocurrency space, I 
      have dedicated my career to building innovative trading solutions that 
