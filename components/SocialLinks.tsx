...
const socialLinks = [
  {
    id: 1,
    title: "SmartFox's Github Profile",
    link: "https://github.com/HereForYou",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
        className="dark:fill-gray-400 hover:fill-accentColor dark:hover:fill-accentColor transition-all"
      >
  ...
  // {
  //   id: 2,
  //   title: "SmartFox's LinkedIn Profile",
